                      ...
                      @foreach ($karyawan as $d)
                          ...
                          <tr>
                              ...
                              <td>
                                ...
                                @else
                                <img src="{{ url($path)}}" alt="nophoto.png" class="avatar">    
                                @endif
                              </td>
                              <td>{{ $d->nama_dept }}</td>
                              <td>
                                <div class="btn-group">
                                  <a class="btn btn-info btn-sm mr-2 edit" nik="{{$d->nik}}">
          ...
          <div class="row">
            <div class="col-12">
              <div class="input-icon mb-3">
                ...
                <input type="text" id="nama_lengkap" class="form-control" name="nama_lengkap" placeholder="Nama Karyawan">
              </div>
            </div>
          </div>
          <div class="row">
