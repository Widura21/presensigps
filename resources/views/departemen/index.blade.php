                ...
                <div class="row mt-2" >
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                <a class="btn btn-info btn-sm mr-2 edit" kode_dept="{{$d->kode_dept}}">
          ...
          <div class="row">
            <div class="col-12">
              <div class="input-icon mb-3">
                ...
                <input type="text" id="nama_dept" class="form-control" name="nama_dept" placeholder="Nama departemen">
              </div>
            </div>
          </div>
          <div class="row">
...
$(function(){
    ...
    $(".edit").click(function(){
      var nama_dept = $(this).attr('kode_dept');
      $.ajax({
        type:'POST',
        url : '/departemen/edit',
        cache : false,
