...
<div class="section" id="user-section">
    <div id="user-detail">
        <div class="avatar">
            ...
            @endphp
            <img src="{{ url($path)}}" alt="avatar" class="imaged w64" style="height: 75px">
            @else
    ...
    <div id="rekappresensi">
        ...
        <div class="row">
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding:12px 12px !important line-height:0.8rem">
                        ...
                        <ion-icon name= "checkmark-outline" style="font-size: 1.6rem" class="text-primary mb-1"></ion-icon>
                        <br>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding:12px 12px !important line-height:0.8rem">
                     ...
                     <ion-icon name= "receipt-outline" style="font-size: 1.6rem" class="text-success mb-1"></ion-icon>   
                     <br>
            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding:12px 12px !important line-height:0.8rem">
                        <span class="badge bg-danger" style="position:absolute; top:3px; right:10px; font-size:0.6rem; z-index:999"></span>
